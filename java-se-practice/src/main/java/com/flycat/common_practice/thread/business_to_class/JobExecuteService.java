...
public class JobExecuteService {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < whoDoJobs.length; i++) {
            String realClassName = "com.flycat.common_practice.thread.business_to_class." + whoDoJobs[i];
            try {
    ...
    public static class JobThread implements Callable<String> {
        ...
        public String call() throws Exception {
            ...
            AnimalJob animalJob = JobManager.getInstance().getJob("com.flycat.common_practice.thread.business_to_class."+className);
